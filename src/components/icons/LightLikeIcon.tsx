export default function LightLikeIcon() {
    return (
        <svg className="w-4.5 h-4.5 cursor-pointer hover:z-10" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" id="like-consumption-small" data-supported-dps="16x16">
            <g>
