export default function HeartLikeIcon() {
    return (
        <svg className="w-4.5 h-4.5 -ml-2 cursor-pointer hover:z-10" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" id="empathy-consumption-small" data-supported-dps="16x16">
            <g>
